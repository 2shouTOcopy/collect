...
│               已加载插件池                        │
├─────────────┬─────────────┬──────────────────────┤
│ Read 插件   │ Write 插件  │ Snapshot 插件        │
│ HasRead()   │ HasWrite()  │ HasSnapshot()        │
├─────────────┼─────────────┼──────────────────────┤
│ cpu         │ csv         │ network              │
│ memory      │ logfile     │ thread               │
│ df          │ json_writer │ dmesg                │
│ uptime      │             │                      │
└─────────────┴─────────────┴──────────────────────┘
```
...
| 插件      | 输出文件      | 说明                         |
| --------- | ------------- | ---------------------------- |
| `network` | `network.txt` | 网络接口、路由、DNS、连接状态 |
| `thread`  | `thread.txt`  | 目标进程线程、CPU、FD、栈信息 |
| `dmesg`   | `dmesg.txt`   | 内核日志                     |
